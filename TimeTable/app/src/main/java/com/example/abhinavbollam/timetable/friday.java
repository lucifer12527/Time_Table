...
public class friday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView lv;
        String[] courses=getResources().getStringArray(R.array.friday);
        lv= (ListView)findViewById(R.id.fridaytable);
        ArrayAdapter<String> adp=new ArrayAdapter<String>(friday.this,android.R.layout.simple_list_item_1,courses);
        lv.setAdapter(adp);
