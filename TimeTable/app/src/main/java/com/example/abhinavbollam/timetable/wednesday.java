...
public class wednesday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView lv;
        String[] courses=getResources().getStringArray(R.array.wednesday);
        lv= (ListView)findViewById(R.id.wednesdaytable);
        ArrayAdapter<String> adp=new ArrayAdapter<String>(wednesday.this,android.R.layout.simple_list_item_1,courses);
        lv.setAdapter(adp);
    }
