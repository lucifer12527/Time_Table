...
public class tuesday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView lv;
        String[] courses=getResources().getStringArray(R.array.tuesday);
        lv= (ListView)findViewById(R.id.tuesdaytable);
        ArrayAdapter<String> adp=new ArrayAdapter<String>(tuesday.this,android.R.layout.simple_list_item_1,courses);
        lv.setAdapter(adp);
    }
