...
public class thurday extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_thurday);
        ListView lv;
        String[] courses=getResources().getStringArray(R.array.thursday);
        lv= (ListView)findViewById(R.id.thursdaytable);
        ArrayAdapter<String> adp=new ArrayAdapter<String>(thurday.this,android.R.layout.simple_list_item_1,courses);
        lv.setAdapter(adp);
    }
